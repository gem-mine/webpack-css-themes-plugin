...
class MiniCssExtractPlugin {
  constructor(options = {}) {
    this.options = {
      ...
      moduleFilename: (id) => `x-${id}-${this.options.filename}` || DEFAULT_FILENAME,
      ignoreOrder: false,
      ...options
    }
      ...
      compilation.mainTemplate.hooks.renderManifest.tap(
        ...
        (result, { chunk }) => {
          ...
          if (renderedModules.length > 0) {
            renderedModules.forEach((renderedModule) => {
              const id = renderedModule._identifierIndex
              result.push({
                ...
                filenameTemplate: () => this.options.moduleFilename(id),
                pathOptions: {
                  chunk,
